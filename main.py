import turtle
import random
TRACK_X,TRACK_Y,TRACK_LEN,TRACK_WIDTH,LANE_WIDTH,LANE_NUMBER_X,LANE_NUMBER_Y,TURTLE_X,TURTLE_Y=-350,200,700,400,100,-380,130,-300,150
FINISH_X=250
def setup_screen():
  global turt, screen
...
def race(user_guess: int):
  while(turtle1.xcor() <= FINISH_X and
         ...
         turtle4.xcor() <= FINISH_X):
          ...
          turtle3.forward(random.randint(1,100))
          turtle4.forward(random.randint(1,100))
